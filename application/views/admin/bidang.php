                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="<?php echo base_url(); ?>index.php/home" class="logo-link nk-sidebar-logo">
                            ...
                            <img class="logo-small logo-img logo-img-small" src="<?php echo base_url(); ?>assets/gambar/kominfo.jpg" srcset="<?php echo base_url(); ?>assets/gambar/kominfo.jpg" alt="logo-small">
                        </a>
                    </div>
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">DATA BIDANG</h3>
                                                    ...
                                                    <ul class="nk-block-tools g-3">
                                                        <li>
                                                            <div class="drodown">
                                                                    ...
                                                                    <li class="nk-block-tools-opt"><a href="<?php echo base_url(); ?>index.php/bidang/tambah" class="btn btn-primary"><em class="icon ni ni-reports"></em><span>Tambah Data Bidang</span></a></li>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                        ...
                                        <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                                            <thead>
                                                <tr class="nk-tb-item nk-tb-head">
                                                    ...
                                                    <th class="nk-tb-col tb-col-sm"><span>Nama Bidang</span></th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col">
                                                        ...
                                                        <span class="tb-sub"><?=$data->nama_bidang?></span>
                                                    </td>
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li><a href="<?=site_url('bidang/update/'.$data->id_bidang)?>"><em class="icon ni ni-edit"></em><span>Edit Data</span></a></li>
                                                                            <li></li>
                                                                            <li></li>
                                                                            <li><a href="<?=site_url('bidang/delete/'.$data->id_bidang)?>" onclick="return confirm('Yakin Hapus?')" name="id_user" method="post" ><em class="icon ni ni-trash"></em><span>Hapus Data</span></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </li>
