                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="<?php echo base_url(); ?>index.php/home" class="logo-link nk-sidebar-logo">
                            ...
                            <img class="logo-dark logo-img" src="<?php echo base_url(); ?>assets/gambar/kominfo.jpg" srcset="<?php echo base_url(); ?>assets/images/logo-dark2x.png 2x" alt="logo-dark">
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Form Edit Bidang</h3>
                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt"><a href="<?php echo base_url(); ?>index.php/sie" class="btn btn-primary"><em class="icon ni ni-reports"></em><span>Kembali</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head-content -->
                                ...
                                <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card">
                                            <div class="card-inner">
                                                <div class="card-head">
                                                    <h5 class="card-title">Edit Data Sie</h5>
                                                </div>
                                                    ...
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <label class="form-label" for="default-01">Nama Bidang *</label>
                                                                </div>
                                                                <input type="text" class="form-control form-control-lg" id="default-01" value="<?=$this->input->post('nama_bidang') ?? $row->nama_bidang ?>" name="nama_bidang"> 
                                                            </div><!-- .foem-group -->
                                                        </div>
                                                        </div><!-- .foem-group -->
                                                        <div class="col-12">
