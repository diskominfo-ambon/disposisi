                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Form Edit Sie</h3>
                                ...
                                <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card">
                                            <div class="card-inner">
                                                ...
                                                <form action="<?php echo base_url(); ?>index.php/sie/update/<?= $row->id_sie ?>" method="post">
                                                <?= validation_errors() ?>
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg" id="default-01" value="<?=$this->input->post('nama_sie') ?? $row->nama_sie ?>" name="nama_sie"> 
                                                            </div><!-- .foem-group -->
                                                        </div>
                                                        </div><!-- .foem-group -->
                                                        <div class="col-12">
