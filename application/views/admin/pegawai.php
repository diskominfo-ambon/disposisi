                                        ...
                                        <a href="#" class="dropdown-toggle mr-n1" data-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-xl-block">
                                                    <div class="user-status user-status-unverified">Verivied</div>
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">DATA PEGAWAI</h3>
                                                    ...
                                                    <ul class="nk-block-tools g-3">
                                                        <li>
                                                            <div class="drodown">
                                                                    ...
                                                                    <li class="nk-block-tools-opt"><a href="<?php echo base_url(); ?>index.php/pegawai/tambah" class="btn btn-primary"><em class="icon ni ni-reports"></em><span>Tambah Data Pegawai</span></a></li>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                        ...
                                        <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                                            <thead>
                                                <tr class="nk-tb-item nk-tb-head">
                                                    ...
                                                    <th class="nk-tb-col tb-col-sm"><span>Nama Jabatan</span></th>
                                                    <th class="nk-tb-col"><span>NIP</span></th>
                                                    <th class="nk-tb-col"><span>ID User</span></th>
                                                    <th class="nk-tb-col"><span>ID Bidang</span></th>
                                                    <th class="nk-tb-col tb-col-md"><span>ID Sie</span></th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col">
                                                        ...
                                                        <span class="tb-sub"><?=$data->nama_jabatan?></span>
                                                    </td>
                                                    <td class="nk-tb-col">
                                                        <span class="tb-sub"><?=$data->nip?></span>
                                                    </td>
                                                    <td class="nk-tb-col">
                                                        <span class="tb-lead"><?=$data->id_user?></span>
                                                    </td>
                                                    <td class="nk-tb-col">
                                                        <span class="tb-sub"><?=$data->id_bidang?></span>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-md">
                                                        <span class="tb-sub"><?=$data->id_sie?></span>
                                                    </td>
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li><a href="<?=site_url('pegawai/update/'.$data->id_pegawai)?>"><em class="icon ni ni-edit"></em><span>Edit Data</span></a></li>
                                                                            <li></li>
                                                                            <li></li>
                                                                            <li><a href="<?=site_url('pegawai/delete/'.$data->id_pegawai)?>" onclick="return confirm('Yakin Hapus?')" name="id_pegawai" method="post" ><em class="icon ni ni-trash"></em><span>Hapus Data</span></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </li>
