                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">DATA SIE</h3>
                                                    ...
                                                    <ul class="nk-block-tools g-3">
                                                        <li>
                                                            <div class="drodown">
                                                                    ...
                                                                    <li class="nk-block-tools-opt"><a href="<?php echo base_url(); ?>index.php/sie/tambah" class="btn btn-primary"><em class="icon ni ni-reports"></em><span>Tambah Data Sie</span></a></li>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                        ...
                                        <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                                            <thead>
                                                <tr class="nk-tb-item nk-tb-head">
                                                    ...
                                                    <th class="nk-tb-col tb-col-sm"><span>Nama Sie</span></th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="nk-tb-item">
                                                    <td class="nk-tb-col">
                                                        ...
                                                        <span class="tb-sub"><?=$data->nama_sie?></span>
                                                    </td>
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li><a href="<?=site_url('sie/update/'.$data->id_sie)?>"><em class="icon ni ni-edit"></em><span>Edit Data</span></a></li>
                                                                            <li></li>
                                                                            <li></li>
                                                                            <li><a href="<?=site_url('sie/delete/'.$data->id_sie)?>" onclick="return confirm('Yakin Hapus?')" name="id_user" method="post" ><em class="icon ni ni-trash"></em><span>Hapus Data</span></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </li>
