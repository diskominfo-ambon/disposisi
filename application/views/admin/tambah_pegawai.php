                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Form Tambah Pegawai</h3>
                                ...
                                <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card">
                                            <div class="card-inner">
                                                ...
                                                <form action="<?php echo base_url(); ?>index.php/pegawai/tambah" method="post">
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg" id="default-01" name="nama_jabatan" value="<?=set_value('nama_jabatan')?>" placeholder="Nama Jabatan">
                                                            </div><!-- .foem-group -->
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    <select class="form-select form-control form-control-xl" data-ui="xl" id="outlined-select" name="id_user" >
                                                                        ...
                                                                        <?php foreach($users as $user): ?>
                                                                            <option value="<?= $user->id_user ?>" option_select_name"><?= $user->nama ?></option>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    <select class="form-select form-control form-control-xl" data-search="on" data-ui="xl" id="outlined-select" name="id_bidang">
                                                                        <option value="">--Pilih--</option>
                                                                        <?php foreach($bidang as $_bidang): ?>
                                                                            <option value="<?= $_bidang->id_bidang ?>"><?= strtoupper($_bidang->nama_bidang) ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                    <label class="form-label-outlined" for="outlined-select">ID Bidang (optional)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg" id="default-01" name="nip" value="<?=set_value('nip')?>" placeholder="1234567">
                                                            </div><!-- .foem-group -->
                                                          <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    <select data-search="on" class="form-select form-control form-control-xl" data-ui="xl" id="outlined-select" name="id_sie">
                                                                        <option value="">--Pilih--</option>
                                                                        <?php foreach ($sie as $_sie): ?>
                                                                            <option value="<?= $_sie->id_sie ?>"><?= $_sie->nama_sie ?></option>
                                                                        <?php endforeach; ?>
                                                                        
                                                                    </select>
                                                                    <label class="form-label-outlined" for="outlined-select">ID Sie (optional)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        </div>
