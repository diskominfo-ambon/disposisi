                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Form Tambah Sie</h3>
                                ...
                                <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card">
                                            <div class="card-inner">
                                                <div class="card-head">
                                                    <h5 class="card-title">Tambah Sie</h5>
                                                </div>
                                                <form action="<?php echo base_url(); ?>index.php/sie/tambah" method="post">
                                                    <div class="row g-4">
                                                        <?php //echo validation_errors(); ?>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control form-control-xl form-control-outlined" id="outlined-normal " name="nama_sie" value="<?=set_value('nama_sie')?>">
                                                                    <label class="form-label-outlined" for="outlined-normal">Input Nama Sie</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        </div>
