                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item">
                                    <a href="<?php echo base_url(); ?>index.php/kasie" class="nk-menu-link">
                                                ...
                                                <form action="<?php echo base_url(); ?>index.php/kasie/tambah" method="post">
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    <select class="form-select form-control form-control-xl" data-ui="xl" id="outlined-select" name="id_pegawai" >
                                                                        <option value="default_option">--Pilih--</option>
                                                                        ...
                                                                        <?php endforeach; ?></select>
                                                                    <label class="form-label-outlined" for="outlined-select">Didisposisikan oleh</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
    ...
    <script>
        $(document).ready(() => {
            $('#field__id-sm').on('change', function () {
                ...
                $.get(window.location.origin + '/disposisi/index.php/kabid/show/' + val, (data) => {
                    if (data.length == 0) {
