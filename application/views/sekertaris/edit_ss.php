                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt"><a href="<?php echo base_url(); ?>index.php/sifat_surat" class="btn btn-primary"><em class="icon ni ni-reports"></em><span>Kembali</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head-content -->
                                ...
                                <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card">
                                            <div class="card-inner">
                                                <div class="card-head">
                                                    <h5 class="card-title">Edit Sifat Surat</h5>
                                                </div>
                                                <form action="<?php echo base_url(); ?>index.php/sifat_surat/update/<?= $row->id_ss ?>" method="post">
                                                <?= validation_errors() ?>
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <label class="form-label" for="default-01">Sifat Surat *</label>
                                                                </div>
                                                                <input type="text" class="form-control form-control-lg" id="default-01" value="<?=$this->input->post('sifat_surat') ?? $row->sifat_surat ?>" name="sifat_surat"> 
                                                            </div><!-- .foem-group -->
                                                        </div>
                                                        </div><!-- .foem-group -->
                                                        <div class="col-12">
