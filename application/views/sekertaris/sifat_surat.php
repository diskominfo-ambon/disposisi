                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item">
                                    <a href="<?php echo base_url(); ?>index.php/surat_masuk" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-tag-alt-fill"></em></span>
                                        <span class="nk-menu-text">Surat Masuk</span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="<?php echo base_url(); ?>index.php/surat_keluar" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-tag-alt-fill"></em></span>
                                        <span class="nk-menu-text">Surat Keluar</span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="<?php echo base_url(); ?>index.php/sifat_surat" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-tag-alt-fill"></em></span>
                                        <span class="nk-menu-text">Sifat Surat</span>
                                    </a>
                                </li>
                            </ul><!-- .nk-menu -->
                        </div><!-- .nk-sidebar-menu -->
                                                        ...
                                                        <li>
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <li class="nk-block-tools-opt"><a href="<?php echo base_url(); ?>index.php/sifat_surat/tambah" class="btn btn-primary"><em class="icon ni ni-reports"></em><span>Tambah Sifat Surat</span></a></li>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                        ...
                                                        <ul class="nk-tb-actions gx-1 my-n1">
                                                            <li class="mr-n1">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li><a href="<?=site_url('sifat_surat/update/'.$data->id_ss)?>"><em class="icon ni ni-edit"></em><span>Edit Data</span></a></li>
                                                                            <li></li>
                                                                            <li></li>
                                                                            <li><a href="<?=site_url('sifat_surat/delete/'.$data->id_ss)?>" onclick="return confirm('Yakin Hapus?')" name="id_ss" method="post" ><em class="icon ni ni-trash"></em><span>Hapus Data</span></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </li>
