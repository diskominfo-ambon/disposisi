                                ...
                                <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card">
                                            <div class="card-inner">
                                                ...
                                                <form action="<?php echo base_url(); ?>index.php/sifat_surat/tambah" method="post">
                                                    <div class="row g-4">
                                                        <?php //echo validation_errors(); ?>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control form-control-xl form-control-outlined" id="outlined-normal " name="sifat_surat" value="<?=set_value('sifat_surat')?>">
                                                                    <label class="form-label-outlined" for="outlined-normal">Sifat Surat</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        </div>
