                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt"><a href="<?php echo base_url(); ?>index.php/staff/tambah" class="btn btn-primary"><em class="icon ni ni-reports"></em><span>Laporan</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head-content -->
                                        ...
                                        <table class="table-responsive datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="nk-tb-item">
                                                    ...
                                                    <td class="nk-tb-col">
                                                        <span class="tb-sub"><?=$data->lampiran?></span>
                                                    </td>
                                                    <td class="nk-tb-col">
